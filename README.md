...
| CloudFoundry CLI | Use command line tools for Cloud Foundry with plugins for blue-green deploy and MTA. | [ppiper/cf-cli](https://hub.docker.com/r/ppiper/cf-cli) |
...
| Life Cycle Container| Use a sidecar image for life-cycle management of the cx-server|[ppiper/cx-server-companion](https://hub.docker.com/r/ppiper/cx-server-companion).|
